...
import com.enation.eop.processor.SensitiveWordHttpRequestWrapper;
	...
	public void doFilter(ServletRequest request, ServletResponse response,
		...
		try {
			...
			if (uri.endsWith(".html")) {
				...
				// httprequest 过滤敏感词       add_by liuyulei   2016-10-17
				SensitiveWordHttpRequestWrapper sensitiveWordHttpRequest = new SensitiveWordHttpRequestWrapper(ThreadContextHolder.getHttpRequest());
				ThreadContextHolder.setHttpRequest(sensitiveWordHttpRequest);
			}
			
			// api处理过滤敏感词       add_by liuyulei   2016-10-17
