...
public class AdColumnManager implements IAdColumnManager {
	...
	@Override
	public AdColumn getADcolumnDetail(String cname) {
		AdColumn  adColumn = this.daoSupport.queryForObject("select * from es_adcolumn where cname = ?", AdColumn.class, cname);
		return adColumn;
	}
