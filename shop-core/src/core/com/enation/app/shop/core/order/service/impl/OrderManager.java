...
public class OrderManager  implements IOrderManager {
	...
	/*
	 * 	(non-Javadoc)
	 * @see com.enation.app.shop.core.order.service.IOrderManager#savePrice(double, int)
	 */
	@Override
	...
	public void savePrice(double price, int orderid) {
		...
		this.daoSupport.execute("update es_order set order_amount=?,need_pay_money=? where order_id=?", price,price,orderid);
		//修改收款单价格 
		String sql="update es_payment_logs set money=? where order_id=?";
		this.daoSupport.execute(sql, price,orderid);
		
		this.daoSupport.execute("update es_order set discount=discount+? where order_id=?",discount, orderid);
	}
	
	/*
	 * (non-Javadoc)
	 * @see com.enation.app.shop.core.order.service.IOrderManager#saveShipmoney(double, int)
	 */
	@Override
	@Transactional(propagation = Propagation.REQUIRED)
	public double saveShipmoney(double shipmoney, int orderid) {
		...
		this.daoSupport.execute(
				"update es_order set order_amount=order_amount+?,need_pay_money=need_pay_money+?,shipping_amount=?,discount=discount+? where order_id=?", shortship,shortship,shipmoney,discount,
				orderid);
	...
	/*
	 * (non-Javadoc)
	 * @see com.enation.app.shop.core.order.service.IOrderManager#log(java.lang.Integer, java.lang.String, java.lang.Integer, java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.enation.app.shop.core.order.service.IOrderManager#log(java.lang.Integer, java.lang.String)
	 */
	@Override
	public void addLog(Integer order_id,String message){
		...
		log.setOp_time(DateUtil.getDateline());
	...
	/*
	 * (non-Javadoc)
	 * @see com.enation.app.shop.core.order.service.IOrderManager#listbyshipid(int, int, int, int, java.lang.String, java.lang.String)
	 */
	@Override
	public Page listbyshipid(int pageNo, int pageSize, int status,
			int shipping_id,String sort, String order) {
		order = " ORDER BY "+sort+" "+order;
		String sql = "select * from es_order where disabled=0 and status="
	...
	/*
	 * (non-Javadoc)
	 * @see com.enation.app.shop.core.order.service.IOrderManager#listConfirmPay(int, int, java.lang.String, java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.enation.app.shop.core.order.service.IOrderManager#get(java.lang.Integer)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.enation.app.shop.core.order.service.IOrderManager#get(java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.enation.app.shop.core.order.service.IOrderManager#listGoodsItems(java.lang.Integer)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.enation.app.shop.core.order.service.IOrderManager#listGoodsItemsByItemId(java.lang.Integer)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.enation.app.shop.core.order.service.IOrderManager#getOrderItem(int)
	 */
	@Override
	public List getOrderItem(int order_id) {
		...
		for(Map item : items){
			...
			Integer is_pack = Integer.parseInt(item.get("is_pack").toString());
			//如果当前商品为套餐商品 add_by DMRain 2016-9-9
			if (is_pack.equals(1)) {
				sql = "select * from es_order_item_child where itemid = ? and orderid = ?";
				List itemList = new ArrayList();
				itemList = this.daoSupport.queryForList(sql, Integer.parseInt(item.get("item_id").toString()), Integer.parseInt(item.get("order_id").toString()));
	...
	/*
	 * (non-Javadoc)
	 * @see com.enation.app.shop.core.order.service.IOrderManager#listLogs(java.lang.Integer)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.enation.app.shop.core.order.service.IOrderManager#clean(java.lang.Integer[])
	 */
	@Transactional(propagation = Propagation.REQUIRED)
	public void clean(Integer[] orderId) {
		...
		sql = "delete from es_delivery_item"
	...
	/*
	 * (non-Javadoc)
	 * @see com.enation.app.shop.core.order.service.IOrderManager#delete(java.lang.Integer[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.enation.app.shop.core.order.service.IOrderManager#revert(java.lang.Integer[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.enation.app.shop.core.order.service.IOrderManager#listOrderByMemberId(int)
	 */
	@Override
	public List listOrderByMemberId(int member_id) {
		String sql = "select * from es_order where member_id = ? order by create_time desc";
		List list = this.daoSupport.queryForList(sql, Order.class,
				member_id);
		return list;
	}
	...
	/*
	 * (non-Javadoc)
	 * @see com.enation.app.shop.core.order.service.IOrderManager#mapOrderByMemberId(int)
	 */
	@Override
	public Map mapOrderByMemberId(int memberId) {
		Integer buyTimes = this.daoSupport.queryForInt(
				"select count(0) from es_order where member_id = ?", memberId);
		Double buyAmount = (Double) this.daoSupport.queryForObject(
				"select sum(paymoney) from es_order where member_id = ?",
	...
	/*
	 * (non-Javadoc)
	 * @see com.enation.app.shop.core.order.service.IOrderManager#edit(com.enation.app.shop.core.order.model.Order)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.enation.app.shop.core.order.service.IOrderManager#listAdjItem(java.lang.Integer)
	 */
	@Override
	...
	public Map censusState() {
		...
		// 分组查询、统计订单状态
		String sql = "select count(0) num,status  from es_order"
...
//		// 将list转为map
		...
		sql="select count(0) from es_order where disabled=0  and ( ( payment_type != 'cod' and status = " + OrderStatus.ORDER_PAY + ") or ( payment_type='cod' and  status = " + OrderStatus.ORDER_CONFIRM + "))";//待发货订单数量
		count=this.daoSupport.queryForInt(sql);
	...
	/*
	 * (non-Javadoc)
	 * @see com.enation.app.shop.core.order.service.IOrderManager#export(java.util.Date, java.util.Date)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.enation.app.shop.core.order.service.IOrderManager#getMemberOrderNum(int, int)
	 */
	public int getMemberOrderNum(int member_id, int payStatus) {
		return this.daoSupport.queryForInt("SELECT COUNT(0) FROM es_order WHERE member_id=? AND pay_status=?",member_id, payStatus);
	}

	/*
	 * (non-Javadoc)
	 * @see com.enation.app.shop.core.order.service.IOrderManager#getItemsByOrderid(java.lang.Integer)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.enation.app.shop.core.order.service.IOrderManager#refuseReturn(java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.enation.app.shop.core.order.service.IOrderManager#updateOrderPrice(double, int)
	 */
	@Override
	public void updateOrderPrice(double price, int orderid) {
		this.daoSupport.execute("update es_order set order_amount = order_amount-?,goods_amount = goods_amount- ? where order_id = ?",
						price, price, orderid);
	}

	/*
	 * (non-Javadoc)
	 * @see com.enation.app.shop.core.order.service.IOrderManager#queryLogiNameById(java.lang.Integer)
	 */
	@Override
	public String queryLogiNameById(Integer logi_id) {
		return (String) this.daoSupport.queryForObject(
				"select name from es_logi_company where id=?", new StringMapper(),
				logi_id);
	}
	
	/*
	 * (non-Javadoc)
	 * @see com.enation.app.shop.core.order.service.IOrderManager#searchForGuest(int, int, java.lang.String, java.lang.String)
	 */
	@Override
	public Page searchForGuest(int pageNo, int pageSize, String ship_name,
		...
		Page page = this.daoSupport.queryForPage(sql.toString(), pageNo,pageSize, Order.class, ship_name, ship_tel, ship_tel);
		return page;
	}

	/*
	 * (non-Javadoc)
	 * @see com.enation.app.shop.core.order.service.IOrderManager#listByStatus(int, int, int, int)
	 */
	@Override
	public Page listByStatus(int pageNo, int pageSize, int status, int memberid) {
		...
		String sql = "select * from es_order where " + filedname
	...
	/*
	 * (non-Javadoc)
	 * @see com.enation.app.shop.core.order.service.IOrderManager#listByStatus(int, int, int)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.enation.app.shop.core.order.service.IOrderManager#listByStatus(int, int)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.enation.app.shop.core.order.service.IOrderManager#getMemberOrderNum(int)
	 */
	@Override
	public int getMemberOrderNum(int member_id) {
		return this.daoSupport.queryForInt(
				"SELECT COUNT(0) FROM es_order WHERE member_id=?", member_id);
	}
	
	/*
	 * (non-Javadoc)
	 * @see com.enation.app.shop.core.order.service.IOrderManager#search(int, int, int, java.lang.String, java.lang.String, java.lang.String, java.lang.String, int, java.lang.Integer)
	 */
	@Override
	public Page search(int pageNO, int pageSize, int disabled, String sn,
		...
		StringBuffer sql = new StringBuffer(
				"select * from es_order where disabled=?  ");
		if (status != -100) {
			if(status==-99){
				/*
				 * 查询未处理订单
		...
		if (!StringUtil.isEmpty(uname)) {
			sql.append(" and member_id  in ( SELECT  member_id FROM es_member where disabled!=1 and uname = '"
					+ uname + "' )  ");
		}
		...
		if (!StringUtil.isEmpty(logi_no)) {
			sql.append(" and order_id in (SELECT order_id FROM es_delivery where logi_no = '"
					+ logi_no + "') ");
		}
	...
	/*
	 * (non-Javadoc)
	 * @see com.enation.app.shop.core.order.service.IOrderManager#search(int, int, int, java.lang.String, java.lang.String, java.lang.String, java.lang.String, int)
	 */
	@Override
	public Page search(int pageNO, int pageSize, int disabled, String sn,
	...
	/*
	 * (non-Javadoc)
	 * @see com.enation.app.shop.core.order.service.IOrderManager#getNext(java.lang.String, java.lang.Integer, java.lang.Integer, int, java.lang.String, java.lang.String, java.lang.String, java.lang.String)
	 */
	@Override
	public Order getNext(String next, Integer orderId, Integer status,
			...
			String ship_name) {
		StringBuffer sql = new StringBuffer(
				"select * from es_order where  1=1  ");
...
//		}
		if (!StringUtil.isEmpty(uname)&&!uname.equals("undefined")) {
			sbsql.append(" and member_id  in ( SELECT  member_id FROM es_member where disabled!=1 and uname = '"
					+ uname + "' )  ");
		}
		if (!StringUtil.isEmpty(ship_name)) {
		...
		if (next.equals("previous")) {
			sql.append("  and order_id IN (SELECT CASE WHEN SIGN(order_id - "
					+ orderId
					+ ") < 0 THEN MAX(order_id)  END AS order_id FROM es_order WHERE order_id <> "
			...
			sql.append("  and  order_id in (SELECT CASE WHEN SIGN(order_id - "
					+ orderId
					+ ") > 0 THEN MIN(order_id) END AS order_id FROM es_order WHERE order_id <> "
					+ orderId + depotsql.toString()+ " and disabled=? "+sbsql.toString()+" GROUP BY SIGN(order_id - " + orderId
					+ ") ORDER BY SIGN(order_id - " + orderId + "))   ");
		} else {
			return null;
	...
	/*
	 * (non-Javadoc)
	 * @see com.enation.app.shop.core.order.service.IOrderManager#delItem(java.lang.Integer, java.lang.Integer)
	 */
	@Override
	@Transactional(propagation = Propagation.REQUIRED)
		...
		if(flag){
			try {
				if(itemnum.intValue() <= item.getNum().intValue()){
					...
					this.daoSupport.execute("update es_order set goods_amount = goods_amount- ?,shipping_amount = ?,order_amount =  ?,weight =  weight - ?,gainedpoint =  ? where order_id = ?"
							, itemprice,sumdlyprice,leftprice,(goods.getWeight().doubleValue() * itemnum.intValue() ),difpoint,order.getOrder_id());
					this.daoSupport.execute("update es_freeze_point set mp =?,point =?  where orderid = ? and type = ?", difpoint,difpoint,order.getOrder_id(),"buygoods");
					if(itemnum.intValue() == item.getNum().intValue()){
						this.daoSupport.execute("delete from order_items where item_id = ?", itemid);
					}else{
						this.daoSupport.execute("update es_order_items set num = num - ? where item_id = ?", itemnum.intValue() ,itemid);
					}
	...
	/*
	 * (non-Javadoc)
	 * @see com.enation.app.shop.core.order.service.IOrderManager#saveAddrDetail(java.lang.String, int)
	 */
	@Override
	@Transactional(propagation = Propagation.REQUIRED)
	...
	/*
	 * (non-Javadoc)
	 * @see com.enation.app.shop.core.order.service.IOrderManager#saveShipInfo(java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, int)
	 */
	@Override
		...
		try {
			if(ship_day !=null && !StringUtil.isEmpty(ship_day)){
				...
				if(remark !=null && !StringUtil.isEmpty(remark)&&!remark.equals("undefined")){
					...
					sb.append("】");
					this.daoSupport.execute("update es_order set remark= concat(remark,'"+sb.toString()+"')   where order_id=?",	orderid);
				}
					return true;
			}
	...
	/*
	 * (non-Javadoc)
	 * @see com.enation.app.shop.core.order.service.IOrderManager#updatePayMethod(int, int, java.lang.String, java.lang.String)
	 */
	@Override
	public void updatePayMethod(int orderid, int payid, String paytype,String payname) {
		
		this.daoSupport.execute("update es_order set payment_id=?,payment_type=?,payment_name=? where order_id=? or parent_id = ?",payid,paytype,payname,orderid,orderid);
	...
	/*
	 * (non-Javadoc)
	 * @see com.enation.app.shop.core.order.service.IOrderManager#listByOrderIds(java.lang.Integer[], java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.enation.app.shop.core.order.service.IOrderManager#list(int, int, int, java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.enation.app.shop.core.order.service.IOrderManager#orderStatusNum(java.lang.Integer)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.enation.app.shop.core.order.service.IOrderManager#list(int, int, int, int, java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.enation.app.shop.core.order.service.IOrderManager#listOrder(java.util.Map, int, int, java.lang.String, java.lang.String)
	 */
	@Transactional(propagation = Propagation.REQUIRED) 
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.enation.app.shop.core.order.service.IOrderManager#saveDepot(int, int)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.enation.app.shop.core.order.service.IOrderManager#savePayType(int, int)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.enation.app.shop.core.order.service.IOrderManager#saveShipType(int, int)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.enation.app.shop.core.order.service.IOrderManager#add(com.enation.app.shop.core.order.model.Order)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.enation.app.shop.core.order.service.IOrderManager#saveAddr(int, int, int, int, java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.enation.app.shop.core.order.service.IOrderManager#getOrderGoodsNum(int)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.enation.app.shop.core.order.service.IOrderManager#getOrderItemDetail(int)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.enation.app.shop.core.order.service.IOrderManager#getOrderByMemberid(java.lang.String, java.lang.Integer)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.enation.app.shop.core.order.service.IOrderManager#checkCod(java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.enation.app.shop.core.order.service.IOrderManager#getRecordList(java.lang.Integer, java.lang.Integer, java.lang.Integer)
	 */
	@Override
	public Page getRecordList(Integer goods_id, Integer pageNo, Integer pageSize) {
		...
		//获取总交易量
		sql="select count(*) from  es_transaction_record where goods_id=? order by record_id";
	...
	/*
	 * (non-Javadoc)
	 * @see com.enation.app.shop.core.order.service.IOrderManager#getCancelApplicationList(java.lang.Integer, java.lang.Integer)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.enation.app.shop.core.order.service.IOrderManager#authCancelApplication(java.lang.Integer, java.lang.Integer)
	 */
	@Override
	@Transactional(propagation = Propagation.REQUIRED)
...
//				refund.setRefund_money(order.getOrder_amount());
				refund.setRefund_money(order.getNeed_pay_money());
	...
	public void addCancelApplication(Integer order_id, String reason) {
		...
		this.daoSupport.execute("UPDATE es_order SET is_cancel=1,cancel_reason=? WHERE order_id=?", reason,order_id);
		this.addLog(order_id, "申请取消订单，取消原因："+reason, "会员");
	}
	/**
	 * 
	 * @param orderId
	...
	private boolean cheack(Integer[] orderId){
		...
		for (int j = 0; j < orderId.length; j++) {
			if(this.daoSupport.queryForInt("select status from es_order where order_id=?",orderId[j])!=OrderStatus.ORDER_CANCELLATION){
				i=false;
			}
		}
		return i;
	...
	private OrderItem getOrderItem(Integer itemid){
		return (OrderItem)this.daoSupport.queryForObject("select * from es_order_items where item_id = ?", OrderItem.class, itemid);
	}
...
//		System.out.println(sql.toString());
	...
	/*
	 * (non-Javadoc)
	 * @see com.enation.app.shop.core.order.service.IOrderManager#getOrderByProductId(java.lang.Integer)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.enation.app.shop.core.order.service.IOrderManager#getItemsByOrderidAndGoodsList(int, java.util.List)
	 */
	@Override
