...
public class MemberManager  implements IMemberManager {
	@Autowired
	private IDaoSupport<Member> daoSupport;
	...
	public Member edit(Member member) {
		...
		if (currentMember != null && currentMember.getMember_id() == member.getMember_id()) {
			//ThreadContextHolder.getSession().removeAttribute(UserConext.CURRENT_MEMBER_KEY);
	...
	public void delete(Integer[] id) {
		...
		String sql = "update es_member set disabled=1 where member_id in (" + id_str + ")";
		this.daoSupport.execute(sql);
	}
	...
	public int login(String username, String password) {
		...
		if (username.contains("@")) {
			sql = "select m.*,l.name as lvname from "
					+ "es_member m left join "
					+ "es_member_lv"
					+ " l on m.lv_id = l.lv_id where m.ss!=1 and m.email=? and password=?";
		}
...
//		System.out.println(sql);
	...
	/*
	 * (non-Javadoc)
	 * @see com.enation.app.base.core.service.IMemberManager#memberListByLv(java.lang.Integer, java.lang.Integer)
	 */
	@Override
	public List<Member> memberListByLv(Integer lv_id, Integer member_id) {
		String sql = "select * from es_member where lv_id = ? and member_id != ? order by point desc";
		List<Member> memberList = this.daoSupport.queryForList(sql, Member.class, lv_id, member_id);
		return memberList;
	}

	/*
	 * (non-Javadoc)
	 * @see com.enation.app.base.core.service.IMemberManager#memberListByRegion(java.lang.Integer, java.lang.Integer, java.lang.Integer, java.lang.Integer)
	 */
	@Override
	public List<Member> memberListByRegion(Integer province_id,
			Integer city_id, Integer region_id, Integer member_id) {
		String sql = "select * from es_member where member_id != ?";
		...
		List<Member> memberList = this.daoSupport.queryForList(sql, Member.class, member_id);
		return memberList;
	}

	/*
	 * (non-Javadoc)
	 * @see com.enation.app.base.core.service.IMemberManager#memberListByKeyword(java.lang.String, java.lang.Integer)
	 */
	@Override
	...
	public Member memberByCmmemid(String cmmemid) {
		String sql = "select * from es_member where cmmemid = ?";
		return this.daoSupport.queryForObject(sql, Member.class, cmmemid);
	}
	
	@Override
	public String queryCmmemid(Integer memberId){
		String sql = "select cmmemid from es_member where member_id = " + memberId;
