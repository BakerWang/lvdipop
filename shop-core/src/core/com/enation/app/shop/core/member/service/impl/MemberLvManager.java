...
public class MemberLvManager implements IMemberLvManager{
	...
	@Autowired
	private IDaoSupport<MemberLv> daoSupport;
	...
	public void add(MemberLv lv) {
		if(lv.getDefault_lv()==1){
			this.daoSupport.execute("update es_member_lv m set m.default_lv=0");
		}
	...
	public void delete(Integer[] id) {
		...
		String sql = "delete from es_member_lv where lv_id in (" + id_str + ") and default_lv!=1";
