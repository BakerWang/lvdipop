...
public class MobileGoodsListTag extends BaseFreeMarkerTag {
	...
	public ApiGoodsManager getApiGoodsManager() {
		return apiGoodsManager;
	}

	public void setApiGoodsManager(ApiGoodsManager apiGoodsManager) {
		this.apiGoodsManager = apiGoodsManager;
	}	
