...
public class StoreSetting {
	...
	public static Integer auth=0;				//商家商品是否审核
	
	public static Integer edit_auth=0;			//商品修改是否审核

	public static Integer self_auth=0;			//自营商品是否审核
	...
	public static String store_themes="/store_themes/themes/";			//店铺模板路径
		/**
		 * 加载店铺设置
		 * 由数据库中加载
		 */
