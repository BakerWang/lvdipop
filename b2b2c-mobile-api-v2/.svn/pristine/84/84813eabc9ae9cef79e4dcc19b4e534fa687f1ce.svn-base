...
public class CommentApiController {
    ...
    public JsonResult count(Integer goodsid) {
        ...
        // 好评数
        countMap.put("good", apiCommentManager.getCommentsCount(goodsid, 2, 3));
        // 中评数
        countMap.put("general",
                apiCommentManager.getCommentsCount(goodsid, 1, 2));
        // 差评数
        countMap.put("poor", apiCommentManager.getCommentsCount(goodsid, 0, 1));
        // 晒图数
