...
public interface IDataManager {
	...
	/**
	 * 【新】数据增加
	 * @param modelEnglishName 模型英文名（表名）
	 * @param contentId 内容id
	 */
	public void add(String modelEnglishName, int channelId, int contentId);
	 ...
	 * @param contentId 内容id
	 */
	public void edit(String modelEnglishName, int channelId, int contentId);
	 ...
	 * @return 以字段名为key字段值为value的map
	 */
	public Map<String, Object> get(int contentId, boolean filter);
}
