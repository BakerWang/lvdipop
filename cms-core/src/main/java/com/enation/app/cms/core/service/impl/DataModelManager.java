...
public class DataModelManager implements IDataModelManager {
	...
	@Autowired
	private IDaoSupport<DataModel> daoSupport;
...
/*		StringBuffer createTbSql= new StringBuffer("create table ");
	...
	public void edit(DataModel dataModel) {
		...
		if(! oldmodel.getEnglish_name().equals(tbname)){// 表名变了，更新表名
			...
			sql.append("es_" + oldmodel.getEnglish_name());
	...
	/*
	 * (non-Javadoc)
	 * @see com.enation.app.cms.core.service.IDataModelManager#get(java.lang.String)
	 */
	@Override
	public DataModel get(String englishName) {
		String sql ="SELECT * FROM es_data_model WHERE english_name = ?";
		return this.daoSupport.queryForObject(sql, DataModel.class, englishName);
	}
